package be.ipeters.activemq;

/* carlpeters created on 09/04/2023 inside the package - be.ipeters.activemq */
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection.start();
            Topic destination = new ActiveMQTopic(
                    "transacted.client.example");

            Session senderSession = connection.createSession(TRANSACTED,
                    Session.AUTO_ACKNOWLEDGE);
            Session receiverSession = connection.createSession(
            ...
            receiver.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    if (message instanceof TextMessage) {
                        try {
                            String value = ((TextMessage) message)
                                    .getText();
                            System.out
                            ...
                            System.out
                                    .println("Could not read the receiver's topic because of a JMSException");
                        }
                    }
                }
            });

            MessageProducer sender = senderSession
    ...
    private static void acceptInputFromUser(Session senderSession,
                                            MessageProducer sender) throws JMSException {
        System.out
                .println("Type a message. Type COMMIT to send to receiver, type ROLLBACK to cancel");
